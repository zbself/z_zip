 ...
 */
package com.zb.as3.zlib.zip.util.zip {
	
	import com.zb.as3.zlib.zip.util.zip.crypt.ICrypto;
	...
	[Event(name="zipDataCompress", type="com.zb.as3.zlib.zip.util.zip.ZipEvent")]
	[Event(name="zipFileCreated", type="com.zb.as3.zlib.zip.util.zip.ZipEvent")]
	[Event(name="zipCompressOnce", type="com.zb.as3.zlib.zip.util.zip.ZipEvent")]
    ...
    private var _crypt:ICrypto;
		...
		*/
		private function internalAddBytes(isDir:Boolean,filename:String,data:ByteArray = null,date:Date = null):ZipHeader{
			...
			_numFiles++;
			var e:ZipEvent = new ZipEvent(ZipEvent.ZIP_COMPRESS_ONCE);
			e.zip_internal::$method = filename;
			dispatchEvent(e);
			return header;
		}
	}
